...
**創意名稱：**&#x200B;創意的名稱。 預設會使用範本名稱或上傳的檔案名稱，但您可以變更名稱。 對於多個創意內容，您可以編輯個別創意內容名稱。 **秘訣：**&#x200B;在創意名稱中加入廣告大小，並使用將創意加入體驗時容易找到的名稱。

**語言：**&#x200B;您與創意內容建立關聯的每個廣告的預設語言。 上傳或編輯多個創意內容時，相同的值會套用至每個選取的創意內容。

**創意大小：** （現有創意為唯讀）創意的尺寸。 如果創意內容中包含的任何影像大於指定大小，則會據此調整大小。
...
**創意名稱：**&#x200B;創意的名稱。 對於新創意，預設會使用檔案名稱，但您可以變更名稱。 對於多個創意內容，您可以編輯個別創意內容名稱。 **秘訣：**&#x200B;在創意名稱中加入廣告大小，並使用將創意加入體驗時容易找到的名稱。
...
**創意名稱：**&#x200B;創意的名稱。 對於新創意，預設會使用檔案名稱，但您可以變更名稱。 對於多個影像，您可以編輯個別的創意名稱。 **秘訣：**&#x200B;請使用將創意內容納入體驗時容易找到的名稱。

**語言：**&#x200B;您與創意內容建立關聯的每個廣告的預設語言。 相同的值會套用至所有選取的影像。 &lt;！ — 確認是否可能在套件層級發生任何事情，以及體驗設定是否只發生在體驗層級：當您將創意內容納入體驗時，您可以選擇自訂體驗的語言偏好設定。
...
**創意名稱：**&#x200B;創意的名稱。 **秘訣：**&#x200B;請使用將創意內容納入體驗時容易找到的名稱。

**創意大小：** （現有廣告為唯讀）創意的尺寸。 如需新創意，請從標準廣告大小的清單中選取。
u
**語言：**&#x200B;您與創意內容建立關聯的每個廣告的預設語言。

**登陸頁面URL：**&#x200B;用來驗證您與創意內容建立關聯的每個廣告的登陸頁面URL。 每個廣告的實際登陸頁面由協力廠商廣告伺服器決定。
