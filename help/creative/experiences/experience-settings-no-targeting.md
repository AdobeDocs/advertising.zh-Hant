...
**[!UICONTROL Ad Type]：** （現有體驗為唯讀）體驗中包含的廣告型別： *[!UICONTROL Standard Display]*、*[!UICONTROL Dynamic Display]*、*[!UICONTROL Standard Video]*&#x200B;或&#x200B;*[!UICONTROL Display Video]*。 儲存體驗後，您就無法變更廣告型別。
