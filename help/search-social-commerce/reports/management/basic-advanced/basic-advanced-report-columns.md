...
| 欄 | 說明 |
| ---- | ---- |
| \[廣告商專屬的自訂（衍生）量度\] | 的值 [您已建立的自訂量度](/help/search-social-commerce/common-tasks/custom-metrics/custom-metric-about.md) 根據現有量度計算。 |
| \[廣告商特定標籤分類\] | 實體層級目前套用至實體的任何標籤分類。 多個標籤分類使用逗號(，)分隔。 |
| \[廣告商特定交易屬性\] | 指定交易屬性或網站參與量度的轉換次數。 |
| \[Google追蹤的轉換/交易屬性\] | 請參閱「GGL\*、GGL_CT\*和GGL_XD_CT\*」專案。 |
| [!UICONTROL 7-Day Click Accuracy] | ([!UICONTROL Portfolio Report])前七天（不包括當天，不包括報表的指定日期範圍）的點按預測平均準確度，以百分比表示。 |
...
| [!UICONTROL Account Status] | Search、Social和Commerce中的帳戶狀態： <ul><li><i>[!UICONTROL Enabled]：</i> （預設）對於同步的廣告網路，Search、Social和Commerce可以登入廣告網路帳戶以擷取促銷活動資料，並啟用最佳化和追蹤產生等其他適用功能。<br><br>對於未同步的廣告網路，可以使用適用的功能，例如最佳化和/或追蹤產生。</li><li><i>[!UICONTROL Disabled]：</i> 對於同步的廣告網路，Search、Social和Commerce不會登入廣告網路帳戶，因此不會擷取行銷活動資料，而且會停用最佳化和追蹤產生等其他適用功能。 系統仍會儲存啟用帳戶時收集的資料，但您日後建立的所有行銷活動管理檢視及所有報表，都不會包含帳戶停用期間的資料。<br><br>對於未同步的廣告網路，無法使用最佳化和/或追蹤產生等適用功能。</li></ul> |
...
| [!UICONTROL Avg Position] | 指定日期範圍內的廣告平均位置。<br><br>對象 [!DNL Google Ads] 和 [!DNL Yahoo! Japan Ads] 行銷活動，此資料僅在2019年9月之前可用。 對象 [!DNL Microsoft Advertising]，此資料僅在2021年1月22日之前可用。 |
| [!UICONTROL Base URL] | 關鍵字的基礎URL，包括為促銷活動或帳戶設定的任何附加引數。 其中不包含任何搜尋、社交和商務重新導向和追蹤程式碼。 |
| [!UICONTROL Bid Strategy] | （大多數廣告網路）對於行銷活動或行銷活動元件，這是行銷活動的競標策略。 對於連結至經理帳戶的廣告網路帳戶，這是跨帳戶競標策略。 可用值會依廣告網路而有所不同。 |
| [!UICONTROL Business Name] | ([!DNL Microsoft Advertising] 回應式廣告)企業名稱。 |
| [!UICONTROL Call to Action] | ([!DNL Microsoft Advertising] 回應式廣告和多媒體廣告)廣告中包含的行動號召。 |
...
| [!UICONTROL Channel Type] | 行銷管道型別： <i>[!UICONTROL Search]</i> 或 <i>[!UICONTROL Content]</i>. 當報告的 [!UICONTROL Search/Content] 報表設定中的設定是&quot;[!UICONTROL Combined].」 |
| [!UICONTROL City] | ([!UICONTROL Geo Distribution Report]， [!UICONTROL Transaction Report])產生點按的城市。 這是根據使用者的IP位址所決定。 |
| [!UICONTROL Click Match Type] | 關鍵字元合所點選廣告的型別。 這與 [!UICONTROL Listing Match Type] 除了 [!DNL Microsoft Advertising] 具有多種相符型別的關鍵字。 對象 [!DNL Microsoft Advertising] 關鍵字，這是實際點按的相符型別。 |
...
| [!UICONTROL Constraint Name] | ([!UICONTROL Constraint Report])限制名稱。 |
| [!UICONTROL Constraint Start Date] | ([!UICONTROL Constraint Report])限製作用中的第一天。 |
| [!UICONTROL Constraint Status] | ([!UICONTROL Constraint Report])限制的狀態：  <i>[!UICONTROL Active]</i> 或 <i>[!UICONTROL Paused]</i>. |
| [!UICONTROL Constraint Type] | ([!UICONTROL Constraint Report])限制型別：  <i>[!UICONTROL Bid/Pos Constraint]</i>， <i>[!UICONTROL Bid Shift]</i>， <i>[!UICONTROL Campaign Budget]</i>， <i>[!UICONTROL Context Sensitive Bid]</i>， <i>[!UICONTROL Incremental Bidding]</i>， <i>[!UICONTROL Max CPA]</i>， <i>[!UICONTROL Min Margin]</i>， <i>[!UICONTROL Variable Bid Position]</i>， <i>[!UICONTROL Search Engine Min Bid]</i>，或 <i>[!UICONTROL Variable Position]</i>. |
| [!UICONTROL Constraints] | 圖元上任何適用限制的名稱，以逗號分隔。 |
| [!UICONTROL Content IS] | 您在顯示/對象網路上收到的廣告曝光數除以您符合資格收到的預估曝光數。 在 [!DNL Microsoft Advertising]，這稱為&quot;[!UICONTROL Audience IS].」 |
| [!UICONTROL Content IS Lost (budget)] | 由於您的每日或每月預算太低，您在顯示/對象網路上的廣告未收到的預估曝光百分比。 在 [!DNL Microsoft Advertising]，這稱為&quot;[!UICONTROL Audience lost IS (budget)].」 |
| [!UICONTROL Content IS Lost (rank)] | 由於廣告排名不佳，您在顯示/對象網路上的廣告未顯示的預估曝光百分比。 在 [!DNL Microsoft Advertising]，這稱為&quot;[!UICONTROL Audience lost IS (rank)].」 |
| [!UICONTROL Conversion Type] | ([!UICONTROL Transaction Report])轉換前的動作：<ul><li><i>[!UICONTROL Click:]</i> 轉換前至少發生一次付費點按。</li><li><i>[!UICONTROL Impression:]</i> 轉換前未發生任何付費點按，因此轉換是由檢視所造成（沒有任何付費點按的印象）。</li></ul> |
| [!UICONTROL Cost] | 指定日期範圍內的廣告總成本。 |
| [!UICONTROL Country] | ([!UICONTROL Geo Distribution Report]， [!UICONTROL Keyword Report])點按產生的國家/地區。 這是根據使用者的IP位址所決定。 |
| [!UICONTROL CPC] | 指定日期範圍內廣告的每次點按成本(CPC)。 |
| [!UICONTROL Creative Base URL] | 廣告的基本URL，包括為促銷活動或帳戶設定的任何附加引數。 其中不包含任何搜尋、社交和商務重新導向和追蹤程式碼。 |
...
| [!UICONTROL Creative Titles] | （僅適用於多媒體和回應式搜尋廣告）為每個廣告的簡短標題新增一欄(」[!UICONTROL Creative Title]「到」[!UICONTROL Creative Title15]「)。 包含此欄時，您不需要包含其他欄 [!UICONTROL Creative Title] 欄，但編輯 [!UICONTROL Order Results/Limit Rows By] 排序依據區段 [!UICONTROL Creative Titles] 而非 [!UICONTROL Creative Title]. |
| [!UICONTROL Creative Type] | 廣告格式。 以下是可能的值： <i>[!UICONTROL App Install Ad]</i>， <i>[!UICONTROL Call Only Ad]</i>， <i>[!UICONTROL Discovery Ad (single-image ads)]</i>， <i>[!UICONTROL Discovery Carousel Ad]</i> （多影像輪播廣告）， <i>[!UICONTROL Display Ad]</i>， <i>[!UICONTROL Dynamic Search Ad]</i>， <i>[!UICONTROL Expanded Dynamic Search Ad]</i>， <i>[!UICONTROL Expanded Text Ad]</i>， <i>[!UICONTROL Legacy Text Ad]</i>， <i>[!UICONTROL Multimedia Ad]</i>， <i>[!UICONTROL Product Ad]</i>， <i>[!UICONTROL Responsive Ad]</i>， <i>[!UICONTROL Responsive Search Ad]</i>，或 <i>[!UICONTROL Text Ad]</i>. |
| [!UICONTROL CTR] | 點進率，即點按次數除以所包含廣告的曝光次數。 |
| [!UICONTROL Currency] | 適用的貨幣型別（例如「USD」或「GBP」）。<br><br><b>注意：</b> 如果報表包含使用不同貨幣的帳戶資料，則任何「[!UICONTROL Total]「貨幣值只是欄中所有數字的總和，不考慮貨幣。 |
| [!UICONTROL Current Bid] | 目標的目前競標。 |
| [!UICONTROL Current First Page Bid] | ([!DNL Google Ads] 僅限行銷活動)在下列情況下，將廣告放在搜尋結果第一頁目前所需的預估每次點按成本(CPC)競標： [!DNL Google] 搜尋查詢符合關鍵字。<br><br>對於單一關鍵字和相符型別組合，此值是該組合目前需要的第一個頁面競標。 在多個行銷活動中使用相同關鍵字和相符型別組合時，此值為目前所有執行個體中所需的最低首頁出價。 |
...
| [!UICONTROL Custom Bid Level] | (僅以顯示網路為目標的Google行銷活動)投出競價的層級：依據 <i>[!UICONTROL Ad Group]</i>， <i>[!UICONTROL Age]</i>， <i>[!UICONTROL Gender]</i>， <i>[!UICONTROL Interest and List]</i>， <i>[!UICONTROL Keyword]</i>， <i>[!UICONTROL Placement]</i>， <i>[!UICONTROL Vertical]</i>， <i>[!UICONTROL None]</i>，或 <i>[!UICONTROL Unknown]</i>. |
| [!UICONTROL Description1] - [!UICONTROL Description4] | 廣告內文。 不同的創意型別有不同數量的必要和選擇性說明行。 若要檢視 [!UICONTROL Description3] 和 [!UICONTROL Description4] 中的欄 [!DNL Microsoft Advertising] 回應式廣告或多媒體廣告，包含「[!UICONTROL Descriptions]」欄。 |
| [!UICONTROL Descriptions] | ([!DNL Microsoft Advertising] 回應式廣告和多媒體廣告)為每個廣告的說明列新增一欄(&quot;[!UICONTROL Description1]「到」[!UICONTROL Description4]「)。 包含此欄時，您不需要包含其他欄 [!UICONTROL Description] 欄。 |
| [!UICONTROL Device] | ([!DNL Google Ads]， [!DNL Microsoft Advertising]， [!DNL Yahoo! Display Network]， [!DNL Yahoo! Japan Ads]、和 [!DNL Yahoo Native] 行銷活動)顯示廣告的裝置型別： <i>[!UICONTROL Computers]</i>， <i>[!UICONTROL Mobile]</i>， <i>[!UICONTROL Tablets]</i>， <i>[!UICONTROL Other]</i>，或 <i>[!UICONTROL N/A]</i> （沒有值）。 其他廣告網路的列值為N/A。<br><br>在搜尋行銷活動中，如果關鍵字、廣告和/或廣告擴充功能的追蹤範本或目的地URL包含依裝置追蹤資料的引數(`&ev_dvc={device}&ev_dvm={devicemodel}`)時，轉換資料也會包含在每種裝置型別的列中。 否則，如果轉換資料無法歸因於裝置型別，則會彙總在具有「」的單獨列中[!UICONTROL Device]的「 」值 [!UICONTROL N/A]. |
| [!UICONTROL Display Path 1] | ([!DNL Google Ads] 僅限延伸文字廣告)廣告的基礎URL之後的第一個顯示路徑。 |
| [!UICONTROL Display Path 2] | ([!DNL Google Ads] 僅限延伸文字廣告)廣告基底URL之後的第二個顯示路徑。 |
| [!UICONTROL Display Type] | 已過時 |
| [!UICONTROL Display URL] | 廣告的顯示URL，這是一般使用者在廣告中看到的內容。 |
| [!UICONTROL DMA] | ([!UICONTROL Geo Distribution Report]， [!UICONTROL Keyword Report])點按產生的指定市場區域（例如丹佛的751）。 這是根據使用者的IP位址所決定。 |
...
| [!UICONTROL Engagements] | （影片廣告）使用者觀看您的廣告至少10秒的次數，或如果完整廣告少於10秒。 |
| [!UICONTROL Est. Clicks] | ([!UICONTROL Geo Distribution Report]；僅搜尋和顯示行銷活動)廣告群組/行銷活動/產品組合的預估點按次數。 此值可能與廣告網路提供的值不同。 |
...
| [!UICONTROL Link Type] | ([!UICONTROL Keyword Report]； [!DNL Google Ads] 和 [!DNL Microsoft Advertising] 僅限行銷活動；只有當為報表指定的歸因規則為「最後一個事件」時，資料才可用)當列報表因點按廣告擴充功能（而不是廣告本身）或產品/購物廣告而導致的轉換時，此欄會顯示所點按連結的型別和標題：<ul><li>`pla:*`  — 產品廣告列為 `pla:<product ID>`，例如「pla：8525822」。</li><li>`sl:*`  — 網站連結列為 `sl:<Sitelink text>`，例如「sl：請參閱目前的選件」。</li></ul> |
| [!UICONTROL Listing Match Type] | 關鍵字元合廣告清單的型別， <i>[!UICONTROL Content]</i> 針對以內容為目標的行銷活動中的廣告，或 <i>[!UICONTROL Sitecpc]</i> 適用於網站目標行銷活動中的版位。 對象 [!DNL Microsoft Advertising] 關鍵字，其中可能包括多種相符型別(例如&quot;[!UICONTROL Broad]，[!UICONTROL Exact]「)。 |
| [!UICONTROL Location] | （顯示行銷活動）目標對象位置。 |
| [!UICONTROL Long Creative Title1] - [!UICONTROL Long Creative Title5] | (在已完成的報表列中，用於 [!DNL Microsoft Advertising] 回應式廣告和多媒體廣告)廣告的長條新聞標題。 若要檢視這些欄，請包含&quot;[!UICONTROL Long Creative Titles]」欄。 |
| [!UICONTROL Long Creative Titles] | (適用於 [!DNL Microsoft Advertising] 回應式廣告和多媒體廣告)為每個廣告的長標題新增一欄(&quot;[!UICONTROL Long Creative Title1]「到」[!UICONTROL Long Creative Title5]「)。 |
...
| [!UICONTROL Metro Code] | ([!UICONTROL Geo Distribution Report]， [!UICONTROL Keyword Report])產生曝光次數或點按次數的數值METRO代碼（例如Denver的us-751）。 這是根據搜尋使用者的IP位址所決定。 |
...
| [!UICONTROL Outbound Clicks] | ([!DNL Meta] 廣告)在廣告中讓使用者離開的連結點選次數 [!DNL Meta]擁有的屬性。 |
| [!UICONTROL Parent Product Groupings] | 父產品群組的完整階層，具有 `>>` 層級之間(例如 `All Products>>CategoryL1=Animals`)（如適用）。 |
...
| [!UICONTROL Portfolio Count] | ([!UICONTROL Portfolio Report])與目標相關聯的投資組合數量。 <!-- This count is different than what I see within the Objectives view. --> |
...
| [!UICONTROL Portfolio Status] | 投資組合狀態：<ul><li><i>[!UICONTROL Optimize]：</i> 最佳化功能會收集相關行銷活動的點選和收入資料、模型化資料以最佳化出價，以及最佳化出價和/或行銷活動預算（視最佳化型別和行銷活動競標策略而定）。</li><li><i>[!UICONTROL Active]：</i> 最佳化功能會收集相關行銷活動的點按和收入資料，並將資料模型化，但不會最佳化競標或行銷活動預算。</li><li><i>[!UICONTROL Inactive]：</i> 最佳化功能會收集相關行銷活動的點選資料以用於製作報表，但此功能不會將資料模型化，也不會將競標或行銷活動預算最佳化。</li></ul> |
| [!UICONTROL Portfolio Target] | ([!UICONTROL Portfolio Report])投資組合的支出策略的每日目標。 對於每日/每月和一週/月的某一天策略，會顯示當天的目標。 |
| [!UICONTROL Preferred Devices] | ([!DNL Google Ads]， [!DNL Microsoft Advertising]、和 [!DNL Yahoo! Japan Ads] 行銷活動)廣告設定是否偏好設定 <i>[!UICONTROL Mobile ads]</i> 或 <i>[!UICONTROL All ads]</i>. |
| [!UICONTROL Product Group ID] | 廣告網路指派給產品群組的數值ID。 |
| [!UICONTROL Product Groupings] | 父級產品群組。 |
| [!UICONTROL Product ID] | ([!UICONTROL Keyword Report]； [!DNL Google Ads] 產品清單廣告)與廣告一起顯示的產品的產品ID。<br><br><b>注意：</b> 只有當產品清單包含追蹤引數時，才會擷取ID `ev_plx=<GMC product ID>`，您必須在其中新增 [!DNL Google Merchant Center]. |
| [!UICONTROL Raw Transaction Data] | ([!UICONTROL Transaction Report])交易屬性的收入（例如1代表一項註冊，12代表一筆12美元的訂單）。 如果多個競標單位具有相同的交易ID，則追蹤ID的收入會根據指定點選日期（點選資料可用時）的點選次數進行分割。 |
| [!UICONTROL Reach] | ([!DNL Meta] ads)至少看過一次您廣告的人數。 注意： [!DNL Meta] 每天刪除使用者設定檔的重複觸及率，因此報告的數字來自 [!DNL Meta] 而且依搜尋、社交和商務可能有所不同。 |
| [!UICONTROL Region] | ([!UICONTROL Geo Distribution Report]， [!UICONTROL Keyword Report])曝光數或點按數源自的地區或美國/加拿大州。 這是根據使用者的IP位址所決定。 |
...
| [!UICONTROL Search (Top) IS] | ([!DNL Google Ads] 和 [!DNL Microsoft Advertising])您從排名最前位置收到的曝光數（在自然搜尋結果上方）除以您有資格從排名最前位置收到的預估曝光數。 低於10%的百分比表示為&quot;`<10%`「或」`0.0999`.」 |
| [!UICONTROL Search Engine] | 廣告網路。 |
| [!UICONTROL Search exact match IS] | 您收到的完全符合關鍵字的搜尋閱聽次數，除以您有資格收到的預估完全符合關鍵字閱聽次數。 如果此數字低，可能是因為您的出價太低或廣告品質或相關性太低。 |
| [!UICONTROL Search impr. share] | ([!DNL Google Ads] 僅限)您收到的曝光數除以您符合資格接收的預估曝光數。 低於10%的百分比表示為「&lt;10%」，高於90%的百分比表示為「`>90%`.」 |
| [!UICONTROL Search lost abs. top IS (budget)] | ([!DNL Google Ads] 和 [!DNL Microsoft Advertising])您的廣告不是第一個超過自然搜尋結果之廣告的時間百分比，因為您的每日或每月預算太低。 針對Google廣告行銷活動，超過90%的百分比會表示為「`>90%`「或」`0.9001`.」 |
| [!UICONTROL Search lost abs. top IS (rank)] | ([!DNL Google Ads] 和 [!DNL Microsoft Advertising])由於廣告排名不佳，導致您的廣告不是第一個高於自然搜尋結果的時間百分比。 針對Google廣告行銷活動，超過90%的百分比會表示為「`>90%`「或」`0.9001`.」 |
| [!UICONTROL Search lost IS (budget)] | ([!DNL Google Ads] 僅限)因為每日或每月預算太低而未顯示廣告的時間百分比。 此量度僅在行銷活動層級提供。 超過90%的百分比會顯示為「`>90%`「或」`0.9001`.」 |
| [!UICONTROL Search lost IS (rank)] | ([!DNL Google Ads] 僅限)由於廣告排名不佳而未顯示廣告的時間百分比。 超過90%的百分比會顯示為「`>90%`「或」`0.9001`.」 |
| [!UICONTROL Search lost top IS (budget)] | ([!DNL Google Ads] 和 [!DNL Microsoft Advertising])您的廣告未顯示在自然搜尋結果上方的時間百分比，因為您的每日或每月預算太低。 對象 [!DNL Google Ads] 行銷活動，超過90%的百分比會表示為&quot;`>90%`「或」`0.9001`.」 |
| [!UICONTROL Search lost top IS (rank)] | ([!DNL Google Ads] 和[！DNL [!DNL Microsoft Advertising]])由於廣告排名不佳而未顯示在自然搜尋結果上方的時間百分比。 針對Google廣告行銷活動，超過90%的百分比會表示為「`>90%`「或」`0.9001`.」 |
| [!UICONTROL Search Term] | ([!UICONTROL Transaction Report])使用者查詢的搜尋字詞。 |
| [!UICONTROL SETrackingOnly] | 您是否追蹤帳戶但未下標： <i>[!UICONTROL TRUE]</i> 或 <i>[!UICONTROL FALSE]</i>. |
| [!UICONTROL Site] | (網域反向連結報告和 [!UICONTROL Keyword Report]；網站目標位置)產生點按的網站。 |
| [!UICONTROL Start Date] | 報告的第一天。 |
| [!UICONTROL State] | (地理分佈報表， [!UICONTROL Keyword Report])產生交易的州/省。 這是根據使用者的IP位址所決定。 |
