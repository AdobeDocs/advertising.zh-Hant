...
>[!NOTE]
>
>對於大多數專業報告，資料會在前一天的23:00 （晚上11:00）提取。 例如，在6月18日的23:00，它會提取6月17日的資料。 如果您在6月19日的09:00 （在提取6月18日的資料之前）執行報表，則報表會包含截至6月17日的23:00資料。 此資料同步適用於所有[!DNL Google Ads]專業報告以及[!UICONTROL Bing Ads Geo Report]和[!UICONTROL Bing Ads Search Query Report]。
