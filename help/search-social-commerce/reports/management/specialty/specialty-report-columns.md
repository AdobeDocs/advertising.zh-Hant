...
| [!UICONTROL All Conversions] | （[!UICONTROL MSA Ad Extension]個報告）轉換次數。 |
| [!UICONTROL All Conversions Qualified] | （[!UICONTROL MSA Ad Extension]個報告）轉換次數。 |
| [!UICONTROL All Cost Per Conversion] | （[!UICONTROL MSA Ad Extension]個報告）每次轉換的成本。 &lt;！ — 與其他欄位如何與一般量度（例如「每次轉換成本」）不同？ —> |
...
| [!UICONTROL Conversions] | （[!UICONTROL MSA Ad Extension]個報告）導致銷售或其他成功度量的點按。 |
...
| [!UICONTROL SE_TERM_ID] | （AdWords搜尋查詢報告）廣告網路所指派的搜尋字詞ID。<!--??? what is this? --> |
