...
| 日期 | 功能 | 說明 | 如需詳細資訊 |
| ---- | ------- | ----------- | -------------------- |
| 2023年6月10日 | [!UICONTROL Recommendations and Publisher Insights] | （開放測試版） | [!UICONTROL Microsoft Advertising] 過去30天內建議的效能深入分析和建議可在以下網址取得： [!UICONTROL Optimization] > [!UICONTROL Recommendations and Publisher Insights]. <b>注意：</b> 雖然建議可協助您改善行銷活動績效，但有些可能不會符合您更廣的目標。 因此，在實作任何建議之前，建議您先洽詢您的Adobe帳戶團隊。 |
