...
* （選用）變更所有報表的適用投資組合：
   ...
   1. （選用）在&#x200B;**[!UICONTROL Select by]**&#x200B;旁邊，選擇如何選取投資組合：
      ...
      * *[!UICONTROL Objectives]：*&#x200B;具有指定&#x200B;**[!UICONTROL Objective].**&#x200B;之指定投資組合的報告 . 您可以變更指定的&#x200B;**[!UICONTROL Currency].**，選擇性縮小產品組合清單 依預設，會選取所有使用USD搭配指定目標的產品組合。

   1. 視需要選取和取消選取投資組合旁的核取方塊，直到[!UICONTROL Selected Portfolios]區段列出您要報告的投資組合。

   1. 按一下&#x200B;**[!UICONTROL Select]**。

* （選擇性）從&#x200B;**[!UICONTROL Granularity]**&#x200B;功能表變更所有報告的資料詳細程度（*[!UICONTROL Daily]* \[預設\]、*[!UICONTROL Weekly]* \[適用於日期範圍\]或&#x200B;*[!UICONTROL Monthly]* \[適用於日期範圍\]）。
