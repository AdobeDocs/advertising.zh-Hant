...
* （選用）變更所有報表的適用投資組合：
  ...
  1. （選用）在&#x200B;**[!UICONTROL Select by]**&#x200B;旁邊，選擇如何選取投資組合：
     ...
     * *[!UICONTROL Portfolio Groups]：*&#x200B;在指定&#x200B;**[!UICONTROL Portfolio Group].**&#x200B;中報告指定的投資組合 您可以變更指定的&#x200B;**[!UICONTROL Currency].**，選擇性地篩選產品組合清單 依預設，會選取指定投資組合群組中所有使用USD的投資組合。

     * *[!UICONTROL Objectives]：*&#x200B;具有指定&#x200B;**[!UICONTROL Objective].**&#x200B;之指定投資組合的報告 . 您可以變更指定的&#x200B;**[!UICONTROL Currency].**，選擇性縮小產品組合清單 依預設，會選取所有使用USD且具有指定目標的產品組合。

  1. 視需要選取和取消選取投資組合旁的核取方塊，直到[!UICONTROL Selected Portfolios]區段列出您要報告的投資組合。

  1. 按一下&#x200B;**[!UICONTROL Select]**。

* （選用）從&#x200B;**[!UICONTROL Data Aggregation]**&#x200B;功能表變更所有報告的資料彙總（*[!UICONTROL Daily]* \[預設\]、*[!UICONTROL Weekly]* \[適用於日期範圍\]或&#x200B;*[!UICONTROL Monthly]* \[適用於日期範圍\]）。
