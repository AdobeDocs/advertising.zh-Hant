...
+ 追蹤{#tracking}
   ...
   + 點選追蹤{#click-tracking}
      ...
      + [Adobe AdvertisingCookie （連結）](https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-advertising-cloud.html?lang=zh-Hant){target="_blank"}
...
+ 行銷活動管理{#campaign-management}
   ...
   + 正在設定帳戶{#campaign-management-accounts}
...
+ 深入分析和報告{#insights-reports}
   ...
   + 報表 {#reports}
      ...
      + 管理報告{#report-management}
         + 基本和進階報告{#basic-advanced-reports}
            ...
            + 進階報告格式{#advanced-report-formats}
      ...
      + 自動化報告{#report-automation}
         + 報告範本{#report-templates}
   ...
   + Recommendations和發佈者深入分析{#recommendations}
