...
archetype: end-user
user-guide-title: Advertising Search, Social, & Commerce 指南
user-guide-description: 本指南說明管理、追蹤及報告您的搜尋、社交和商務廣告行銷活動所需的主要功能、工作、設定和其他資源。
...
+ 追蹤 {#tracking}
   ...
   + 點選追蹤 {#click-tracking}
      ...
      + [Adobe AdvertisingCookie （連結）](https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-advertising-cloud.html){target="_blank"}
