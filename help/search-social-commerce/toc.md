...
+ (Beta)新使用者介面 {#new-ui}
   ...
   + 管理 {#manage}
      ...
      + 行銷活動 {#campaigns}
         ...
         + [在[!UICONTROL Campaigns]檢視中檢視效能圖表](/help/search-social-commerce/new-ui/manage/campaigns/campaign-view-performance-graph.md)
      ...
      + 廣告群組 {#ad-groups}
         ...
         + [在[!UICONTROL Ad Groups]檢視中檢視效能圖表](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-view-performance-graph.md)
