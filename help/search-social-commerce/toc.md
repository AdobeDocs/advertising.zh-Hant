...
+ [關於本指南](help-about.md)
+ 簡介 {#intro}
  + [關於Adobe Advertising Search、Social和Commerce](/help/search-social-commerce/introduction/about.md)
...
+ 常見任務 {#common-tasks}
  ...
  + 自訂資料檢視 {#data-views}
    ...
    + 臨機操作檢視設定 {#ad-hoc-settings}
      + [從欄標題功能表編輯欄集合](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-column-heading.md)
      + [從[!UICONTROL Custom Columns]圖示編輯及排序資料行集](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
  ...
  + 一般導覽、編輯和選取工作 {#navigation-editing-selection}
...
+ (Beta)新使用者介面 {#new-ui}
  ...
  + 管理 {#manage}
    + 產品組合 {#portfolios}
      ...
      + [管理投資組合群組](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-group-manage.md)
      + [建立投資組合](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-create.md)
    ...
    + 行銷活動 {#campaigns}
      ...
      + 依廣告網路區分的促銷活動設定 {#campaign-settings-by-network}
        ...
        + [[!DNL ChatGPT Ads]行銷活動設定](/help/search-social-commerce/new-ui/manage/campaigns/campaign-settings-chatgpt.md)
        ...
        + [[!DNL Microsoft Advertising]行銷活動設定](/help/search-social-commerce/new-ui/manage/campaigns/campaign-settings-microsoft.md)
        + [[!DNL Yandex]行銷活動設定](/help/search-social-commerce/new-ui/manage/campaigns/campaign-settings-yandex.md)
    + 廣告群組 {#ad-groups}
      ...
      + 依廣告網路區分的廣告群組設定 {#ad-group-settings-by-network}
        ...
        + [[!DNL ChatGPT Ads]廣告群組設定](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-settings-chatgpt.md)
    ...
    + 廣告 {#ads}
      ...
      + 依廣告網路區分的廣告設定 {#ad-settings-by-network}
        ...
        + [[!DNL Microsoft Advertising]多媒體廣告設定](/help/search-social-commerce/new-ui/manage/ads/ad-settings-microsoft-multimedia.md)
        + [[!DNL Microsoft Advertising]產品廣告設定](/help/search-social-commerce/new-ui/manage/ads/ad-settings-microsoft-product.md)
    ...
    + 排程報告 {#scheduled}
      ...
      + 排程報表型別 {#report-types}
        + 基本和進階報表 {#basic-advanced-reports}
          ...
          + [基本和進階報表設定](/help/search-social-commerce/new-ui/reports/management/basic-advanced/basic-advanced-report-settings.md)
          + [基本和進階報表的報表欄](/help/search-social-commerce/new-ui/reports/management/basic-advanced/basic-advanced-report-columns.md)
        + 協助報表 {#assist-reports}
          + [關於協助報表](/help/search-social-commerce/new-ui/reports/management/assist/assist-report-about.md)
          ...
          + [協助報表設定](/help/search-social-commerce/new-ui/reports/management/assist/assist-report-settings.md)
        + 專業報告 {#specialty-reports}
          + [關於專業報告](/help/search-social-commerce/new-ui/reports/management/specialty/specialty-report-about.md)
          ...
          + [專業報告設定](/help/search-social-commerce/new-ui/reports/management/specialty/specialty-report-settings.md)
          + [專業報告的報告欄](/help/search-social-commerce/new-ui/reports/management//specialty/specialty-report-columns.md)
        + 模型正確性報表 {#model-accuracy-reports}
          + [關於模型精度報表](/help/search-social-commerce/new-ui/reports/management/model-accuracy/model-accuracy-report-about.md)
...
+ 行銷活動管理 {#campaign-management}
  + 簡介 {#campaign-management-intro}
    ...
    + [搜尋、社交和Commerce中的[!DNL Google Ads]轉換資料](/help/search-social-commerce/campaign-management/introduction/google-conversion-data.md)
    + [搜尋、社交和Commerce中的[!DNL Microsoft Advertising]轉換資料](/help/search-social-commerce/campaign-management/introduction/microsoft-conversion-data.md)
  + 設定帳戶 {#campaign-management-accounts}
    + 廣告網路帳戶 {#ad-network-accounts}
      ...
      + [更新 [!DNL Google Ads] 帳戶的AMO ID追蹤代碼](/help/search-social-commerce/campaign-management/accounts/update-amo-id-google.md)
  ...
  + 管理行銷活動 {#management}
    ...
    + 管理[!UICONTROL Campaigns] > [!UICONTROL Campaigns]檢視中的資料 {#campaigns}
      ...
      + 行銷活動 {#campaigns}
        ...
        + 依廣告網路區分的促銷活動設定 {#campaign-settings-by-network}
          ...
          + [[!DNL LY Ads]行銷活動設定](/help/search-social-commerce/campaign-management/campaigns/campaign-settings-yahoo-japan.md)
          + [[Meta Ads]行銷活動設定](/help/search-social-commerce/campaign-management/campaigns/campaign-settings-meta.md)
      ...
      + 關鍵字 {#keywords}
        ...
        + 依廣告網路區分的關鍵字設定 {#keyword-settings-by-network}
          ...
          + [[!DNL LY Ads]關鍵字設定](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yahoo-japan.md)
      ...
      + 對象和對象目標 {#audiences-and-targets}
        + 對象 {#audiences}
          ...
          + [建立來自 [!DNL Adobe] 受眾的 [!DNL Google Ads] 客戶比對受眾](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-adobe-audience.md)
          + [從Adobe Campaign電子郵件清單建立 [!DNL Google Ads] 客戶比對對象](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-campaign-email-list.md)
          + [使用客戶資料清單管理客戶比對受眾](/help/search-social-commerce/campaign-management/campaigns/audience-from-customer-data-list.md)
      ...
      + 廣告擴充功能 {#ad-extensions}
        + [!DNL Google Ads]圖說文字延伸 {#callouts}
          + [關於 [!DNL Google Ads] 圖說文字延伸](/help/search-social-commerce/campaign-management/campaigns/callout-extension-about.md)
          + [管理 [!DNL Google Ads] 圖說文字延伸](/help/search-social-commerce/campaign-management/campaigns/callout-extension-manage.md)
          + [將 [!DNL Google Ads] 共用圖說文字擴充功能與行銷活動或廣告群組建立關聯](/help/search-social-commerce/campaign-management/campaigns/callout-extension-associate.md)
        + 網站連結擴充功能 {#sitelinks}
    ...
    + 透過大量表單管理大量資料 {#bulksheets}
      ...
      + [驗證Bulksheet檔案中的登入頁面](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-validate-landing-pages.md)
      + [匯出產生或上傳的大量表單檔案](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-export.md)
  ...
  + 管理標籤分類 {#label-classifications}
    ...
    + [從行銷活動管理檢視將分類值指派給帳戶元件](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management.md)
    + [使用大量表單指派分類值給帳戶元件](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets.md)
  ...
  + [檢視和建立廣告資產](/help/search-social-commerce/campaign-management/asset-view-create.md)
  + 搜尋行銷活動的最佳實務 {#best-practices-search}
    ...
    + [最佳化網站登陸頁面](/help/search-social-commerce/campaign-management/best-practices/best-practices-optimize.md)
  + [每個廣告網路帳戶的物件數目上限](/help/search-social-commerce/campaign-management/max-objects-per-ad-network.md)
  + [關於行銷活動管理的常見問題集](/help/search-social-commerce/campaign-management/faqs-campaigns.md)
+ 見解與報表 {#insights-reports}
  ...
  + 報表 {#reports}
    ...
    + 管理報表 {#report-management}
      ...
      + 協助報表 {#assist-reports}
        + [關於協助報表](/help/search-social-commerce/reports/management/assist/assist-report-about.md)
        + 協助報表格式 {#assist-report-formats}
    ...
    + 自動化報表 {#report-automation}
      + 報表範本 {#report-templates}
        ...
        + [編輯報表範本](/help/search-social-commerce/reports/automation/templates/template-edit.md)
      ...
      + 試算表摘要 {#spreadsheet-feeds}
        ...
        + [建立試算表報表摘要的 [!DNL Excel] 範本](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create-excel-template.md)
    ...
    + [自訂報表常見問題集](/help/search-social-commerce/reports/faqs-report.md)
  + 通知 {#notifications}
    ...
    + [啟用和停用[!UICONTROL Notification Center]的推播通知](/help/search-social-commerce/notifications/notifications-push-enable-disable.md)
    + [安裝及解除安裝[!UICONTROL Notification Center]網頁應用程式](/help/search-social-commerce/notifications/notification-app-install-uninstall.md)
  + 自訂警報 {#alerts}
    + [關於自訂警報](/help/search-social-commerce/alerts/alert-about.md)
    + 警示範本 {#alert-templates}
...
+ 工具 {#tools}
  ...
  + 建立和解碼追蹤標籤的工具{#tracking}
    ...
    + [產生和實作Adobe Advertising轉換標籤](/help/search-social-commerce/tools/conversion-tag-generate.md)
  + 正在將轉換資料上傳至廣告網路 {#upload-ad-networks}
...
+ 管理 {#admin}
  ...
  + [同步 [!DNL Adobe] 個對象](/help/search-social-commerce/admin/sync-adobe-audiences.md)
  + 設定資料來源 {#data-sources}
    + [關於同步 [!DNL Google Analytics] 轉換量度](/help/search-social-commerce/admin/data-sources/data-source-about.md)
    + [設定a [!DNL Google Analytics] 資料來源的先決條件](/help/search-social-commerce/admin/data-sources/data-source-prerequisites.md)
    + [將 [!DNL Google Analytics] 檢視設定為資料來源](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
