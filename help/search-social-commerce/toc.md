...
+ (Beta)新使用者介面 {#new-ui}
   ...
   + 報表 {#reports}
      + 標籤分類 {#label-classifications}
         ...
         + [從行銷活動管理檢視指派分類值給帳戶元件](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management)
         ...
         + [從帳戶元件移除標籤分類值](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-remove)
...
+ 追蹤 {#tracking}
   ...
   + 轉換追蹤 {#conversion-tracking}
      ...
      + Adobe Advertising轉換追蹤 {#advertising-conversion-tracking}
         ...
         + [產生並實作Adobe Advertising轉換標籤](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/tools/tracking/conversion-tag-generate)
      ...
      + 管理[!UICONTROL Campaigns] > [!UICONTROL Campaigns]檢視中的資料 {#campaigns}
         ...
         + 對象和對象目標 {#audiences-and-targets}
            + 對象 {#audiences}
               ...
               + [建立來自 [!DNL Google Ads] 受眾的 [!DNL Adobe] 客戶比對受眾](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-adobe-audience.md)
