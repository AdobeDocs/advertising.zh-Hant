...
* 選項2：從[ > ](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-about.md) > [!UICONTROL Search, Social, & Commerce]上傳包含您想要之帳戶資料量的[!UICONTROL Campaigns]大量工作表檔案[!UICONTROL Bulksheets]。 若為[!DNL Google Ads]、[!DNL Microsoft Advertising]、[!DNL Naver]、[!DNL Yandex]和現有的[!DNL Baidu]帳戶，您可以將資料張貼至廣告網路。 針對[!DNL Naver]，您可以上傳資料以供搜尋、社交和Commerce使用，但無法將其張貼至廣告網路。

  您可以選擇下載含有現有[!DNL Pinterest]、[!DNL Yahoo Native]和[!DNL Yahoo! Display Network]帳戶資料的Bulksheet檔案，但無法上傳或張貼。

* 選項3：設定自動化程式，以根據您在[ > ](/help/search-social-commerce/campaign-management/inventory-feeds/inventory-feeds-about.md) > [!UICONTROL Search, Social, & Commerce]中建立的廣告網路特定廣告範本，[!UICONTROL Campaigns]建立帳戶結構，以及針對您詳細目錄[!UICONTROL  Advanced (ACM)]中每個專案的動態廣告和關鍵字。 根據您手動上傳或上傳至FTP位置的詳細目錄資料檔案內容，或[!DNL Google Merchant Center]或[!DNL Microsoft Merchant Center]帳戶的內容建立範本。 您可以設定您的資料在建立後立即自動張貼，或是在您檢閱資料後手動張貼至廣告網路。 此選項適用於[!DNL Google Ads]、[!DNL Microsoft Advertising]、[!DNL Yahoo! Japan Ads]和[!DNL Yandex]帳戶。
