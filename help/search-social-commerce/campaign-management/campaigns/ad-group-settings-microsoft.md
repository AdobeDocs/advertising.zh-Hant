...
連線電視(CTV)廣告投放視您的視訊品質和競標金額而定。 檢視CTV廣告[的](https://help.ads.microsoft.com/#apex/ads/en/60102/0/#TechnicalRequirements)技術需求。
...
如需有關可用性的資訊，請參閱[!DNL Microsoft Advertising] 「防止廣告出現在特定網站[」的說明。](https://help.ads.microsoft.com/#apex/bae/en/14061/0)
