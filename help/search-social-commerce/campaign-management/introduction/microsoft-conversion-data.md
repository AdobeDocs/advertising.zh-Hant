...
搜尋、社交和商務會自動同步您追蹤的所有轉換， [[!DNL Microsoft® Advertising] 通用事件追蹤(UET)標籤](https://about.ads.microsoft.com/solutions/tools/universal-event-tracking) 用於網站轉換，包括瀏覽轉換，以利報表和最佳化。
