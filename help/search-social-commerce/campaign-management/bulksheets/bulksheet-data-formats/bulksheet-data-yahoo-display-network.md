---
title: ' [!DNL Yahoo DSP] 帳戶的Bulksheet資料'
description: 參考 [!DNL Yahoo DSP] 帳戶之已下載大量表單中的標題欄位和資料欄位。
...
# 附錄 — [!DNL Yahoo DSP]帳戶的Bulksheet資料
...
您可以大量下載[!DNL Yahoo DSP] （先前為[!DNL Yahoo! Display Network]）帳戶的資料，但無法上傳或張貼大量工作表至廣告網路。
