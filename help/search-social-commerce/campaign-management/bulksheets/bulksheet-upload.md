...
>[!NOTE]
>
>如果您將Bulksheet資料張貼到廣告網路，您可以在[!UICONTROL Progress]檢視中的[!UICONTROL Bulksheets]欄追蹤檔案進度。 大量資料需要更長的時間才能發佈。
