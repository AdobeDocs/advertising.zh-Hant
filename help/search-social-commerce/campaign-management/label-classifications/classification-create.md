...
建立標籤分類之後，您就可以建立分類的特定標籤值，並使用Bulksheets[從](classification-values-assign-campaign-management.md)行銷活動管理檢視[或](classification-values-assign-bulksheets.md)將標籤值指派給帳戶實體。
