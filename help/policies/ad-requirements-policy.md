...
適用於Adobe Advertising DSP和Adobe Advertising搜尋、社交和Commerce的&#x200B;**

此廣告需求政策（「政策」）列明透過Adobe Advertising的[!DNL Adobe’s] On-demand Services （「服務」）所分發廣告的需求。 此原則是使用隨選服務，參考納入[!DNL Adobe]與客戶（「您」）之間的合約。 本政策中所使用但此處未定義的專有名詞，其意義將列於該合約中。
...
您透過「隨選服務」傳輸、儲存、顯示、發佈或以其他方式提供的所有廣告都必須符合Adobe Advertising廣告規格中的廣告規格，可能由[!DNL Adobe]不時修訂。
