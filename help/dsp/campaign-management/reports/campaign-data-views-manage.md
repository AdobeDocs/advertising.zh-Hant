...
您可以跨行銷活動或單一行銷活動變更所有資料視覺效果的量度和圖表模式。 單一行銷活動的變更會套用至行銷活動的所有資料視覺效果，包括[!UICONTROL Packages]、[!UICONTROL Placements]和[!UICONTROL Ads]檢視中的資料視覺效果。
...
* 在資料視覺效果的右上角，按一下[!UICONTROL Overlay]切換引數（![重疊切換引數](/help/dsp/assets/overlay.png)），以在重疊模式（所有圖表重疊在一起）和格線圖模式（三個個別的圖表）之間變更。

## 管理資料表 {#data-tables-manage}

在所有行銷活動管理檢視（[!UICONTROL Campaigns]、[!UICONTROL Packages]、[!UICONTROL Placements]和[!UICONTROL Ads]）中，您可以自訂資料表中顯示的資料。

### 管理欄檢視 {#column-views-manage}

每個行銷活動管理層級（[!UICONTROL Campaigns]、[!UICONTROL Packages]、[!UICONTROL Placements]和[!UICONTROL Ads]）都包含內建的[!UICONTROL Pacing]和[!UICONTROL Performance]檢視，其中包含該實體的相關量度。 依預設，會顯示[!UICONTROL Pacing]檢視，以便您一眼即可識別表現不佳的行銷活動和行銷活動元件。 您可以選擇建立和編輯自訂欄集合。
...
1. 在檢視選擇器中，按一下![向下箭頭](/help/dsp/assets/chevron-down.png)，然後按一下&#x200B;**[!UICONTROL Create View]**。
...
1. 套用或儲存設定：
   ...
   * 若要將設定儲存至新的自訂欄檢視，請按一下&#x200B;**[!UICONTROL Save As]**。 在[!UICONTROL Save View]視窗中輸入新檢視的名稱，然後按一下&#x200B;**[!UICONTROL Save]**。
...
1. 在檢視選擇器中，按一下![向下箭頭](/help/dsp/assets/chevron-down.png)，然後按一下&#x200B;**[!UICONTROL Edit View]**。
...
1. 在主工具列中按一下![篩選按鈕](/help/dsp/assets/filter.png)。
...
* 針對特定範圍，請執行下列任一項作業：
   ...
   * 按一下![行事曆](/help/dsp/assets/calendar.png "行事曆")，然後按一下行事曆內的開始日期和結束日期。
...
在任何頁面的右下方，**[!UICONTROL Items per page]**&#x200B;旁，選取&#x200B;*[!UICONTROL 25]*、*[!UICONTROL 50]*&#x200B;或&#x200B;*[!UICONTROL 100]*。
