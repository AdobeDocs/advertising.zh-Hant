...
1. 執行下列任一項作業：
   ...
   * （適用於封裝）在[!UICONTROL Packages]檢視中，按一下封裝名稱旁的&#x200B;**[!UICONTROL ...]** > **[!UICONTROL Troubleshooting Agent]**。

   * （針對位置）在子功能表中，按一下&#x200B;**[!UICONTROL Placements]**。 在位置名稱旁，按一下「**[!UICONTROL ...]** > **[!UICONTROL Troubleshooting Agent]**」。
