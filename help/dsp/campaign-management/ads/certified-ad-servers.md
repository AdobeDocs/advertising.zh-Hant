...
| [!DNL Jivox] |  | X |  |  |  |
| [!DNL Kargo] |  | X |  | X | 320x50 Anchor、BYOC、Hover、Breakout、Squaret和Sidek;300x250高樓外流；標準案頭顯示（不需要特定廣告插件ID）;視頻錨點（僅限VAST）</br></br>聯繫您的Adobe客戶團隊以獲取有關設定廣告單位的幫助。 |
| [!DNL Linkstorm] |  |  | X |  |  |
| [!DNL mCanvas] |  |  | X |  |  |
| [!DNL Medialets] |  | X |  |  |  |
