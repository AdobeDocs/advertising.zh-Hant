...
**[!UICONTROL Final VAST Tag]:** （僅使用VAST標籤的廣告）具有必要條件的第三方廣告源的URL [廣告DSP跟蹤宏](/help/dsp/campaign-management/macros.md) 插入（如果適用）。

**[!UICONTROL Select Rate]:** （僅具有權限的用戶）通過Adobe計費的預協商費率，或您已協商並將通過供應商計費的費率之一。 要添加費率，請與Adobe帳戶團隊聯繫。
