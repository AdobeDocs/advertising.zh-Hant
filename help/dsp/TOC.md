...
+ 簡介 {#introduction}
   + [AdobeAdvertising DSP簡介](/help/dsp/introduction/dsp-about.md)
   + 主要功能 {#features}
...
+ Campaign Management {#campaign-management}
   ...
   + 版位 {#placements}
      ...
      + [查看版位的更改日誌](/help/dsp/campaign-management/placements/placement-change-log.md)
   ...
   + 廣告 {#ads}
      ...
      + [將廣告附加至版位](https://experienceleague.adobe.com/docs/advertising/dsp/campaign-management/placements/ad-attach-to-placement.html)<!-- Dupe link to this file (in Placements chapter), so need to use an absolute link in one of the listings -->
...
+ 對象 {#audiences}
   ...
   + 管理區段 {#segments}
      ...
      + [!UICONTROL CCPA Opt-out-of-Sale] 區段 {#ccpa-opt-out-of-sale-segments}
         ...
         + [建立和實作 [!UICONTROL CCPA Opt-out-of-Sale] 區段](/help/dsp/audiences/ccpa-opt-out-segment-create.md)
   ...
   + 管理受眾 {#reusable-audiences}
      ...
      + [將可重複使用對象的區段索引鍵複製到剪貼簿](/help/dsp/audiences/reusable-audience-clipboard.md)
...
+ 庫存 {#inventory}
   ...
   + [!DNL On Demand] 庫存 {#on-demand}
      ...
      + 可用 [!DNL On Demand] Premium Inventory發佈商 {#publishers}
      ...
      + [重新要求 [!DNL On Demand] 高級庫存交易](/help/dsp/inventory/on-demand-inventory-rerequest.md)
      + [檢視您的 [!DNL On Demand] 交易要求與訂閱](/help/dsp/inventory/on-demand-inventory-view-status.md)
   + 私人詳細目錄 {#private-inventory}
      + [關於私有清單](/help/dsp/inventory/private-inventory-about.md)
      + 交易ID {#deal-ids}
         + [!UICONTROL Deal ID Inbox] {#inbox}
            + [關於 [!UICONTROL Deal ID Inbox]](/help/dsp/inventory/deal-id-inbox-about.md)
            + [接受 [!UICONTROL Deal ID Inbox]](/help/dsp/inventory/deal-id-inbox-accept.md)
         + 手動輸入的交易ID {#manual}
      ...
      + [編輯可存取私人交易的廣告商](/help/dsp/inventory/deal-id-edit-advertisers.md)
...
+ 管理 {#admin}
   ...
   + 使用者 {#users}
      ...
      + [重新發送待定用戶邀請](/help/dsp/admin/user-resend-invite.md)
      + [取消邀請待定使用者](/help/dsp/admin/user-uninvite.md)
   + 被阻止的站點 {#sites}
