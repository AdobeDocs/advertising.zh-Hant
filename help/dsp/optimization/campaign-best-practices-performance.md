...
您也需要判斷導致整體目標的成功事件，並據此建立自訂目標。 針對每個封裝，指定要與整體最佳化目標搭配使用的自訂目標，以使用[!DNL Adobe AI]進行報告和演演算法最佳化。 如需自訂目標的詳細資訊，請參閱&quot;[管理自訂目標](/help/dsp/admin/custom-objectives-manage.md)&quot;和&quot;[自訂目標的最佳實務](custom-goal.md)&quot;。
