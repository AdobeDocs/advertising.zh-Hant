...
1. 編輯[交易設定](deal-id-settings.md)。
   ...
   您無法編輯[!UICONTROL Deal ID]、[!UICONTROL Publisher]、[!UICONTROL SSP]、[!UICONTROL Deal Type]或[!UICONTROL Billing Method]設定。
...
>* [指定私人交易的版位與廣告](/help/dsp/inventory/deal-id-attach-placements.md)
