...
DSP是[the [!DNL Adobe Real-Time CDP]](https://experienceleague.adobe.com/docs/experience-platform/rtcdp/overview.html)的整合式&#x200B;*目的地*，它是Adobe Experience Platform的一部分。
