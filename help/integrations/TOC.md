...
+ 與Adobe Audience Manager整合 {#audience-manager}
  ...
  + DSP媒體資料與Adobe Audience Manager整合 {#media-data-ingestion}
    + [將DSP媒體曝光度資料傳送至Adobe Audience Manager的相關概述](/help/integrations/audience-manager/media-data-integration/overview.md)
    + [從DSP行銷活動收集曝光次數和點選次數資料](/help/integrations/audience-manager/media-data-integration/collect.md)
...
+ 與Adobe Customer Journey Analytics整合 {#customer-journey-analytics}
  ...
  + {hide-from-toc}[疑難排解](/help/integrations/customer-journey-analytics/troubleshooting-new.md)
  + {hide-from-toc}[疑難排解](/help/integrations/customer-journey-analytics/troubleshooting-new-accordian.md)
  + {hide-from-toc}[疑難排解](/help/integrations/customer-journey-analytics/troubleshooting-new-tables.md)
