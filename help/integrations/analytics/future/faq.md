...
答：我們檢查了產品，他們指出問題畫素是為了提高Ad Cloud、特定詳細目錄/SSP合作夥伴（關於DSP）與AAM之間的Cookie匹配率。  如果移除這些畫素，客戶可能會發現AAC/AAM與詳細目錄合作夥伴之間個別畫素適用的匹配率有些程度降低，但他們不會預期這會相當大。

對於Ad Cloud搜尋，我們確實看到廣告商的CX Enterprise組織ID已針對Mathworks設定，但我們的產品團隊沒有看到Mathworks設定以在Ad Cloud中啟用對象。 您是否使用Adobe Audience Manager傳送受眾至Ad Cloud搜尋？ 如果沒有，移除這些專案不會影響目前的工作流程。 如果您不想引發這些畫素，AAM客戶服務可協助您移除這些畫素。
