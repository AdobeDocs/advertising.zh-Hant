---
title: Adobe Advertising與Adobe Analytics整合
...
# Adobe Advertising與Adobe Analytics整合
...
### 使用[!DNL Analytics]區段來建立[!DNL Google Ads]個對象 {#audience-manager-google-audiences}
...
### 使用[!DNL Analytics]區段來鎖定或排除廣告 {#analytics-targets}
...
* （使用Advertising Creative的廣告商）您可以使用現有的[!DNL Analytics]區段，作為廣告體驗中特定創意內容的目標。
