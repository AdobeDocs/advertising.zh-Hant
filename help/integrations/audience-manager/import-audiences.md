...
* （具有[!DNL Analytics]的廣告商）廣告商必須[使用 [!DNL Analytics] `appMeasurement.js` 1.6.4或更新版本實作](https://experienceleague.adobe.com/en/docs/analytics/implementation/js/overview)。
